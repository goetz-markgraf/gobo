...
- How does the system fail safely when [invalid input, missing permission, or external dependency failure] occurs?
- What prevents accidental data loss or unsafe destructive actions in [relevant workflow]?
...
<!--
  ...
  Include at least one outcome that proves the primary workflow remains safe,
  understandable, and verifiable for users or maintainers.
-->
